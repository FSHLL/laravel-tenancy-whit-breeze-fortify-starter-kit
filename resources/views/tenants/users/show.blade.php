                ...
                <div class="p-6 sm:p-8">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('tenants.users.edit', [$tenant, $user]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 dark:focus:ring-offset-gray-800">
