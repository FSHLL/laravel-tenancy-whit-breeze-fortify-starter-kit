...
class DestroyTenantUserTest extends TestCase
{
    ...
    /** @test */
    public function authenticated_user_can_delete_tenant_user_with_valid_password(): void
    {
    ...
    /** @test */
    public function delete_fails_with_invalid_password(): void
    {
        $password = 'ValidPassword123!';
    ...
    /** @test */
    public function delete_fails_with_missing_password(): void
    {
        $response = $this->actingAs($this->authenticatedUser)
            ->delete(route($this->route, [$this->tenant, $this->tenantUser]), []);
    ...
    /** @test */
    public function delete_fails_with_empty_password()
    {
        $response = $this->actingAs($this->authenticatedUser)
            ->delete(route($this->route, [$this->tenant, $this->tenantUser]), [
                'password' => '',
    ...
    /** @test */
    public function delete_displays_success_message()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_removes_user_completely_from_database()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_handles_non_existent_tenant()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_handles_non_existent_user()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_validates_password_belongs_to_authenticated_user()
    {
    ...
    /** @test */
    public function delete_preserves_other_tenant_users()
    {
    ...
    /** @test */
    public function delete_cannot_delete_user_from_different_tenant()
    {
        $otherTenant = Tenant::factory()->create();
        $otherTenantUser = User::factory()->create(['tenant_id' => $otherTenant->id]);
    ...
    /** @test */
    public function delete_prevents_sql_injection_attempts()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_handles_concurrent_deletion_gracefully()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_validates_csrf_protection()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
    ...
    /** @test */
    public function delete_with_very_long_password_is_handled_gracefully()
    {
    ...
    /** @test */
    public function delete_redirects_to_correct_tenant_users_index()
    {
        $password = 'ValidPassword123!';
        $this->authenticatedUser->update(['password' => Hash::make($password)]);
